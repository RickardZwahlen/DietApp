...
public class DietFragment extends android.support.v4.app.Fragment {
    ...
    {
        super.onStart();
        DietImageAdapter dietImageAdapter = new DietImageAdapter(getActivity());
        GridView gridview = (GridView)getActivity().findViewById(R.id.diets_view);
        gridview.setAdapter(dietImageAdapter);
    }
