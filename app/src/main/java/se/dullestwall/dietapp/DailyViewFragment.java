...
public class DailyViewFragment extends Fragment {
     ...
     * {@link com.example.android.common.view.SlidingTabLayout}.
     */
    static class SamplePagerItem {
        ...
        Fragment createFragment() {
            return DailyViewRecipeFragment.newInstance(mTitle, mIndicatorColor, mDividerColor);
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_mon), // Title
                Color.GREEN, // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_tue), // Title
                Color.BLUE, // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_wed), // Title
                Color.rgb(128,0,128), // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_thu), // Title
                Color.RED, // Indicator color
                Color.GRAY // Divider color
        ));
        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_fri), // Title
                Color.rgb(255,153,0), // Indicator color
                Color.GRAY // Divider color
        ));
        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_sat), // Title
                Color.rgb(255,192,203), // Indicator color
                Color.GRAY // Divider color
        ));
        mTabs.add(new SamplePagerItem(
                getString(R.string.tab_sun), // Title
     ...
     * {@link se.dullestwall.dietapp.DailyViewFragment.SampleFragmentPagerAdapter}. The {@link com.example.android.common.view.SlidingTabLayout} is then given the
     ...
     * are instances of {@link DailyViewRecipeFragment} which just display three lines of text. Each page is
     * created by the relevant {@link se.dullestwall.dietapp.DailyViewFragment.SamplePagerItem} for the requested position.
     * <p>
    ...
    class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
         ...
         * <p>
         * Here we return the value returned from {@link se.dullestwall.dietapp.DailyViewFragment.SamplePagerItem#createFragment()}.
         */
        @Override
         ...
         * <p>
         * Here we return the value returned from {@link se.dullestwall.dietapp.DailyViewFragment.SamplePagerItem#getTitle()}.
         */
        @Override
